        ...
        <form method="POST" action="{{ route('checkout.pay', $product) }}">
            ...
            <div class="grid grid-cols-6 grid-rows-8 gap-2 py-6">
                <div class="col-start-3 row-start-2">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="first-name" id="first-name" type="text" placeholder="Diego Alejandro" value="{{ $user->name }}">
                ...
                <div class="col-start-4 row-start-2">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="surname" id="surname" type="text" placeholder="Ospina Upegui">
                    <p class="text-red-500 text-xs italic">Por favor, llenar este campo.</p>
                </div>
                <div class="col-start-3 row-start-3">
                    ...
                    <select class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="document-type" id="document-type" type="text">
                ...
                <div class="col-start-4 row-start-3">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="document" id="document" type="text" placeholder="1234567890">
                    <p class="text-red-500 text-xs italic">Por favor, llenar este campo.</p>
                </div>
                <div class="col-start-3 row-start-4">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="email" id="email" type="text" placeholder="diego@mail.com" value="{{ $user->email }}">
                    <p class="text-red-500 text-xs italic">Por favor, llenar este campo.</p>
                </div>
                <div class="col-start-4 row-start-4">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="mobile" id="mobile" type="tel" placeholder="3113234434">
                    <p class="text-red-500 text-xs italic">Por favor, llenar este campo.</p>
                </div>
