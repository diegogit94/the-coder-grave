    ...
    <div class="grid grid-cols-3 grid-rows-8 gap-2 py-6">
        <div class="col-start-2 row-start-2">
            <div class="card border-2 text-center">
                <div class="card-header text-lg font-semibold">{{ __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="border-2 form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
